 ...
 * ​그리고 (x|y)는 x또는 y중에서 아무거나 하나만을 선택해서 만든 소리의 집합,
 * 즉 집합{x, y}를 의미한다. 예를 들면(1001|0101)은 집합으로 {1001, 0101}을 의미한다.
 * 따라서 (0|1)~은 0과 1로 이루어진 모든 스트링의 집합, 즉 모든 소리의 집합을 말한다.
 ...
 * 다시 말해서 이것은 100~1~과 01을 임의로 섞어서 만들 수 있는 모든 스크링의 집합을 나타낸다.
 ...
 */
public class _2671IdentifiedSubmarine {
    public static void main(String[] args){
        ...
        while(sc.hasNextLine()){
            ...
            for(int j = 0; j < inputLength; j++){
                now =find[inputLine.charAt(j)-'0'][now];
            }
